...
#all_projections['UMAP']    = (umap.UMAP(), {'n_components': [2], 'random_state': [42], 'n_neighbors': [5, 10], 'metric': ['euclidean'], 'init': ['spectral'], 'min_dist': [0.001], 'spread': [1.0], 'angular_rp_forest': [False]})
